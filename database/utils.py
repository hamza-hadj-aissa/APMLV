...
def insert_volume_entity(session: Session, model: LogicalVolume | VolumeGroup | PhysicalVolume, info_model: LogicalVolumeInfo | VolumeGroupInfo | PhysicalVolumeInfo, name_column, uuid_column, name, uuid):
