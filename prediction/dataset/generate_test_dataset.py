...
if __name__ == "__main__":
    ...
    for disk_capacity in disks_capacities:
        ...
        volume_history = generate_usage_history(
            "4fa5dc13-ab08-44d4-a44f-5876e96ab242", volume_name, disk_capacity, number_of_minutes=60*24*30, spike_hour=random.randint(1, 1440))
        dataset.extend(volume_history)

    write_to_csv(
        dataset, "test_logical_volume.csv")
